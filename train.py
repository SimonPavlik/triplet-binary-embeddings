...
def train_net(config):
    # UNPACK CONFIGS
    (train_filenames, _, img_mean) = unpack_configs(config)
    ...
    for idx in bits_idxes:
        ...
        hash_step1_code = h5py.File('./step1/temp/hash_step1_code_' + str(idx + 1) + '.mat')
    ...
    while epoch < config['n_epochs']:
        ...
        this_validation_error, this_validation_loss = get_val_error_loss(shared_x, shared_y, img_mean, val_filenames,
                                                                         val_labels,
